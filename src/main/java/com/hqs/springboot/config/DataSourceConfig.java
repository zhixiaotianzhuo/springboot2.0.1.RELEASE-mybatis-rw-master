...
public class DataSourceConfig {
    ...
    /**
     * Step One - 项目启动时，通过Spring JDBC 快速创建 DataSource
     * 参数格式
     * spring.datasource.master.jdbcurl=jdbc:mysql://localhost:3306/v-master
     * spring.datasource.master.username=root
     * spring.datasource.master.password=1233211234567
    ...
    /**
     * Step Two - 项目启动时，手动创建DruidDataSource,通过DataSourceProperties 读取配置
     * 参数格式
     * spring.datasource.url=jdbc:mysql://localhost:3306/v-slave
